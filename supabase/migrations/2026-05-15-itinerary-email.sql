...
insert into message_templates (key, label, description, subject, body, placeholders) values
  (
    ...
    'Auto-fires when a trainee is registered AND their class has a location assigned (no longer TBD). Daily 10 AM Eastern cron. Sent once per trainee.',
    'Your training itinerary — Week of {weekDate} at {locationName}',
    'Hello {firstName},
